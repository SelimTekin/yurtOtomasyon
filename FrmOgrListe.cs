...
namespace yurtOtomasyon
{
    public partial class FrmOgrListe : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'yurtOtotmasyonDataSet3.ogrenci' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.ogrenciTableAdapter.Fill(this.yurtOtotmasyonDataSet3.ogrenci);
